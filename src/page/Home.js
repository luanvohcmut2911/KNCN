  ...
  useEffect(() => {
    ...
    function startAnimation() {
      animation = setInterval(function () {
        var currentBottom = parseInt(floatingImage2.style.bottom, 10) || 0;
  ...
  return (
    <Layout style={{ height: "100vh" }}>
      ...
      >
        ...
        >
          <img
            className="conain-image"
            style={slideImg}
            src="https://images.alphacoders.com/301/301253.jpg"
            alt="mission"
          />
          <img
            className="conain-image"
            style={slideImg}
            src="https://images5.alphacoders.com/112/1125315.jpg"
            alt="gambit"
          />
          <img
            className="conain-image"
            style={slideImg}
            src="https://images4.alphacoders.com/646/646889.jpg"
            alt="godfather"
          />
          <img
            className="conain-image"
            style={slideImg}
            src="https://images2.alphacoders.com/817/817125.jpg"
            alt="spiderman"
          />
          <img
            className="conain-image"
            style={slideImg}
            src="https://images5.alphacoders.com/118/1188416.jpg"
            alt="spiderman"
          />
          <img
            className="conain-image"
        ...
        >
          <img
            className="conain-image"
            style={slideImg}
            src="https://images.alphacoders.com/869/869845.jpg"
            alt="mission"
          />
          <img
            className="conain-image"
            style={slideImg}
            src="https://wallpapercave.com/wp/wp383267.jpg"
            alt="gambit"
          />
          <img
            className="conain-image"
            style={slideImg}
            src="https://wallpapercave.com/wp/wp2016392.jpg"
            alt="godfather"
          />
          <img
            className="conain-image"
            style={slideImg}
            src="https://images8.alphacoders.com/123/1236928.jpg"
            alt="spiderman"
          />
          <img
            className="conain-image"
            style={slideImg}
            src="https://images8.alphacoders.com/104/1046291.jpg"
            alt="godfather"
          />
          <img
            className="conain-image"
            style={slideImg}
            src="https://images8.alphacoders.com/616/616460.jpg"
            alt="spiderman"
          />
        </div>
        <div
